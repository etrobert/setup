_: {
  # The sync topology, shared by the NixOS system service and aaron's
  # home-manager one. `dataDir` is where the folder lands on the host.
  flake.lib.syncthingSettings =
    { dataDir }:
    {
