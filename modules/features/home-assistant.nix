  ...
  flake.nixosModules.homeAssistant = _: {
    ...
    services.home-assistant = {
      ...
      config = {
        ...
        homeassistant = {
          # Passwordless from the flat and our own devices only; the tailnet
          # may hold nodes that are not ours (#1200), and `home/` forwards
          # the client IP through.
          auth_providers = [
            {
              ...
              trusted_networks = [
                "127.0.0.1/32"
                "192.168.0.0/24"
                "100.103.91.42/32" # tower
                "100.85.115.23/32" # leod
                "100.126.189.37/32" # aaron
                "100.69.75.125/32" # iPhone
              ];
