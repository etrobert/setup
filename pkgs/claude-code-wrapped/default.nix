{ inputs, ... }:
{
  perSystem =
    ...
    {
      packages = {
        claude-code-wrapped = pkgs.callPackage ./package.nix common;

        claude-code-wrapped-glm = pkgs.callPackage ./package.nix (
          common
          // {
            extraEnv = {
        ...
        claude-code-wrapped-copilot = pkgs.callPackage ./package.nix (
          common
          // {
            extraEnv = {
